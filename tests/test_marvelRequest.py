...
class TestMarvelRequest(TestCase):
    ...
    def test_get_page_not_exist(self):
        endpoint = '/v1/public/characters'
        response = MarvelRequest().get(endpoint, 1000, 100)
        data = json.loads(response.text)
